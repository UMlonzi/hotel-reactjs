...
export default function Sign_In() {
    ...
    return (
        ...
        <div className="login-register-container1">
          {isRegistering ? (
            <>
              <input
                type="email"
              ...
              <button className="create-account-button1" onClick={() => setIsRegistering(false)}>Go back</button>
            </>
          ) : (
            <>
              ...
              <input
                ...
                placeholder="Password"
              />
              <button className="sign-in-register-button1" onClick={handleSignIn}>
                Sign In
              </button>
              <button
